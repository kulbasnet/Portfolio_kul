...
function About() {
  ...
  return (
    <main onMouseMove={manageMouse} id="about" className="flex relative w-full min-h-dvh items-center justify-center">
      ...
      <div className=" mt-[90px] md:mt-[150px] w-full flex justify-center px-4 sm:px-6 md:px-10">
              <p 
              id="para" 
